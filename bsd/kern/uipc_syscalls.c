...
int sockargs(struct mbuf **, caddr_t buf, int buflen, int type);
int getsock(struct filedesc *, int fdes, struct file **);
int sendit(struct proc *p, int s, struct msghdr *mp, int flags, register_t *retsize);
int recvit(struct proc *p, int s, struct msghdr *mp, caddr_t namelenp, register_t *retsize);
